...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, backData_1, u, user, _a, legData_1, u, user, _b, bicepsData_1, u, user;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _i = 0, backData_1 = backData;
                    _c.label = 1;
                case 1:
                    if (!(_i < backData_1.length)) return [3 /*break*/, 4];
                    u = backData_1[_i];
                    return [4 /*yield*/, prisma.back.create({
                            data: u,
                        })];
                case 2:
                    user = _c.sent();
                    console.log("Exercicio adicionado: ".concat(user.name));
                    _c.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4:
                    ...
                    _a = 0, legData_1 = legData;
                    _c.label = 5;
                case 5:
                    if (!(_a < legData_1.length)) return [3 /*break*/, 8];
                    u = legData_1[_a];
                    return [4 /*yield*/, prisma.leg.create({
                            data: u,
                        })];
                case 6:
                    user = _c.sent();
                ...
                case 8:
                    ...
                    _b = 0, bicepsData_1 = bicepsData;
                    _c.label = 9;
                case 9:
                    if (!(_b < bicepsData_1.length)) return [3 /*break*/, 12];
                    u = bicepsData_1[_b];
                    return [4 /*yield*/, prisma.biceps.create({
                            data: u,
                        })];
                case 10:
                    user = _c.sent();
